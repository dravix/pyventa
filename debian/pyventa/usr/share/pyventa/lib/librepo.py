...
class Ventas:
    ...
    def detallarProds(self,limit=20):
      ...
      tabla=libutil.listaHtml(self.ventas['prods'],"Total de ventas por mejores productos",[[7,'Ref.'],[35,'Producto'],[10,'Ventas realizadas'],[10,'U. Vendidas'],[8,'Unidad'], [10,'Monto total'],[10,'Stock <br/>actual'],[10,'Requeridas']],'#fff',"#239AB1", 12) 
      return tabla
