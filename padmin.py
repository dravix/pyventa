#!/usr/bin/env python
# -*- coding: utf-8 -*-
import sys, os, datetime, urllib.request, tarfile, base64, sqlite3
...
from PyQt6.QtWidgets import QMessageBox, QDialog, QMainWindow, QInputDialog, QApplication, QTableWidgetItem
from PyQt6.QtCore import SIGNAL, Qt, QTimer, QLocale
...
#Recibe una consulta de sql la ejecuta y tabula el resultado
    ...
    def notify(self,tipo,event,detail='',time=5):
            ...
            dia.setWindowFlags(dia.windowFlags()|QtCore.Qt.WindowType.FramelessWindowHint)
            dia.show()
