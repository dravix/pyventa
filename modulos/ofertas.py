...
from PyQt6.QtCore import Qt, SIGNAL, QModelIndex, QDate
from PyQt6.QtWidgets import QMessageBox, QDialog, QMenu
...
class Oferta:
    def __init__(self,parent):
        self.ui=parent
        self.index=7
        self.ui.tvOfertas.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.CustomContextMenu)
    ...
    def eliminar(self,index=None):
        ...
        if isinstance(index,QModelIndex):
          ...
          msgBox=QMessageBox(QMessageBox.Question,"Eliminar promocion","Confirma eliminar la promocion %s?"%key,QMessageBox.Yes|QMessageBox.No,self.ui, QtCore.Qt.WindowType.WindowStaysOnTopHint)
          ret=msgBox.exec()
