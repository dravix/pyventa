...
class Productos:
 ...
 #edicion Masiva
    ...
    def eliminarProducto(self):
        msgBox=QMessageBox(QMessageBox.Question,"Confirmar eliminacion","Confirma eliminar los productos seleccionados? Esta operacion no puede deshacerse.",QMessageBox.Yes|QMessageBox.No,self.parent, Qt.WindowStaysOnTopHint)
