...
class Productos:
    ...
    def setupSignals(self):
        self.parent.tblProductos.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.CustomContextMenu)
    ...
    def setTools(self):
        ...
        #actionInicio.triggered.connect(self.goHome)
        ...
        #actionInicio.triggered.connect(self.close)
        ...
        #action.triggered.connect(self.productos.eliminarProducto)
 ...
 #edicion Masiva
    ...
    def eliminarProducto(self):
        msgBox=QMessageBox(QMessageBox.Question,"Confirmar eliminacion","Confirma eliminar los productos seleccionados? Esta operacion no puede deshacerse.",QMessageBox.Yes|QMessageBox.No,self.parent, QtCore.Qt.WindowType.WindowStaysOnTopHint)
            ...
            if ref>0:
              ...
              if int(vendidos[0])>0:
                ...
                try:
                    ...
                    pass
          QMessageBox.information(self.parent, "Producto(s) eliminado(s)", "La operacion ha finalizado correctamente.")
          self.buscar()
    ...
    def cambiarPrecios(self):
      ...
      productos=[item for key,item in productos.items()]
