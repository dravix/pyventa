...
class Compras:
    def __init__(self,parent):
                ...
                self.ui.tvCompras.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.CustomContextMenu)
                self.ui.twNCompra.setContextMenuPolicy(QtCore.Qt.ContextMenuPolicy.CustomContextMenu)
                self.index=6
    ...
    def buscarProducto(self):
        ...
        self.ui.lencCodigo.setText(str(dlg.exec()))
