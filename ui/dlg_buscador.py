...
import  datetime
import MySQLdb
class buscador(QtWidgets.QDialog, Ui_Dialog):
    def __init__(self,parent,texto='',campos=['Ref','Descripcion','Precio'],multi=False):
        ...
        self.leFiltro.returnPressed.connect(self.buscar)
        self.cbDep.activated.connect(self.filtrarFamilias)
        self.cbFam.activated.connect(self.buscar)
